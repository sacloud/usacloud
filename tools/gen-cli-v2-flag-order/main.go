...
func Usage() {
	...
	fmt.Fprint(os.Stderr, "\tgen-cli-v2-flag-order\n")
	os.Exit(2)
}

func main() {
	log.SetFlags(0)
	log.SetPrefix("gen-cli-v2-flag-order: ")

	for _, resource := range ctx.Resources {
		filePath := filepath.Join(destination, resource.CLIFlagOrderSourceFileName())
...
var srcTemplate = `// Code generated by 'github.com/sacloud/usacloud/tools/gen-cli-v2-flag-order'; DO NOT EDIT
