...
func Usage() {
	...
	fmt.Fprint(os.Stderr, "\tgen-resource-finder\n")
	os.Exit(2)
}

func main() {
	log.SetFlags(0)
	log.SetPrefix("gen-resource-finder: ")
...
var srcTemplate = `// Code generated by 'github.com/sacloud/usacloud/tools/gen-resource-finder'; DO NOT EDIT
		...
		{{ end -}}
			for _, a := range strings.Split(arg, "\n") {
				...
				if id := sacloud.StringID(idOrName); !id.IsEmpty() {
					...
					for _, v := range res.{{.FindResultFieldName}} {
						{{ if not .NoSelector }}if len(param.Selector) == 0 || hasTags(&v, param.Selector) { {{ end }}
							ids = append(ids, v.GetID())
