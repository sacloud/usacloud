...
func Usage() {
	...
	fmt.Fprint(os.Stderr, "\tgen-cli-v2-normalize-flag-name\n")
	os.Exit(2)
}

func main() {
	log.SetFlags(0)
	log.SetPrefix("gen-cli-v2-normalize-flag-name: ")
...
var srcTemplate = `// Code generated by 'github.com/sacloud/usacloud/tools/gen-cli-v2-normalize-flag-name'; DO NOT EDIT
