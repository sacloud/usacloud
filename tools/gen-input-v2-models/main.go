...
func New{{.Name}}(in Input) (*{{.Name}}, error) {
	v := &{{.Name}} {
		{{ range .Initializers }}{{ if .Default }}{{.Name}}: {{.Default}},{{ end }}{{ end -}}
		input: in,
	}
...
func (p *{{.Name}}) WriteSkeleton(writer io.Writer) error {
...
func (p *{{.Name}}) ResourceDef() *schema.Resource {
	return define.Resources["{{.R}}"]
}

func (p *{{.Name}}) CommandDef() *schema.Command {
	return p.ResourceDef().Commands["{{.C}}"]
}

func (p *{{.Name}}) IncludeFields() []string {
	return p.CommandDef().IncludeFields
}

func (p *{{.Name}}) ExcludeFields() []string {
	return p.CommandDef().ExcludeFields
}

func (p *{{.Name}}) TableType() output.TableType {
	return p.CommandDef().TableType
}

func (p *{{.Name}}) ColumnDefs() []output.ColumnDef {
