...
func NewListDiskParam(in Input) (*ListDiskParam, error) {
	v := &ListDiskParam{
		input: in,
	}
...
func NewCreateDiskParam(in Input) (*CreateDiskParam, error) {
	v := &CreateDiskParam{
		Plan: "ssd", Connection: "virtio", Size: 20, input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
	}
...
func NewReadDiskParam(in Input) (*ReadDiskParam, error) {
	v := &ReadDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewUpdateDiskParam(in Input) (*UpdateDiskParam, error) {
	v := &UpdateDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewDeleteDiskParam(in Input) (*DeleteDiskParam, error) {
	v := &DeleteDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewEditDiskParam(in Input) (*EditDiskParam, error) {
	v := &EditDiskParam{
...
func NewResizePartitionDiskParam(in Input) (*ResizePartitionDiskParam, error) {
	v := &ResizePartitionDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewReinstallFromArchiveDiskParam(in Input) (*ReinstallFromArchiveDiskParam, error) {
	v := &ReinstallFromArchiveDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewReinstallFromDiskDiskParam(in Input) (*ReinstallFromDiskDiskParam, error) {
	v := &ReinstallFromDiskDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewReinstallToBlankDiskParam(in Input) (*ReinstallToBlankDiskParam, error) {
	v := &ReinstallToBlankDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewServerConnectDiskParam(in Input) (*ServerConnectDiskParam, error) {
	v := &ServerConnectDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewServerDisconnectDiskParam(in Input) (*ServerDisconnectDiskParam, error) {
	v := &ServerDisconnectDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewMonitorDiskParam(in Input) (*MonitorDiskParam, error) {
	v := &MonitorDiskParam{
		KeyFormat: "sakuracloud.disk.{{.ID}}.disk", input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
	}
...
func NewWaitForCopyDiskParam(in Input) (*WaitForCopyDiskParam, error) {
	v := &WaitForCopyDiskParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
