...
func NewListInterfaceParam(in Input) (*ListInterfaceParam, error) {
	v := &ListInterfaceParam{
		input: in,
	}
...
func NewPacketFilterConnectInterfaceParam(in Input) (*PacketFilterConnectInterfaceParam, error) {
	v := &PacketFilterConnectInterfaceParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewCreateInterfaceParam(in Input) (*CreateInterfaceParam, error) {
	v := &CreateInterfaceParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewPacketFilterDisconnectInterfaceParam(in Input) (*PacketFilterDisconnectInterfaceParam, error) {
	v := &PacketFilterDisconnectInterfaceParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewReadInterfaceParam(in Input) (*ReadInterfaceParam, error) {
	v := &ReadInterfaceParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewUpdateInterfaceParam(in Input) (*UpdateInterfaceParam, error) {
	v := &UpdateInterfaceParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
...
func NewDeleteInterfaceParam(in Input) (*DeleteInterfaceParam, error) {
	v := &DeleteInterfaceParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
