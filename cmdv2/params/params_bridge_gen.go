...
func NewListBridgeParam(in Input) (*ListBridgeParam, error) {
	v := &ListBridgeParam{
		input: in,
	}
...
func NewCreateBridgeParam(in Input) (*CreateBridgeParam, error) {
	v := &CreateBridgeParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewReadBridgeParam(in Input) (*ReadBridgeParam, error) {
	v := &ReadBridgeParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewUpdateBridgeParam(in Input) (*UpdateBridgeParam, error) {
	v := &UpdateBridgeParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewDeleteBridgeParam(in Input) (*DeleteBridgeParam, error) {
	v := &DeleteBridgeParam{
		input: in,
	}
	if err := v.validate(); err != nil {
