...
func NewListSshkeyParam(in Input) (*ListSshkeyParam, error) {
	v := &ListSshkeyParam{
		input: in,
	}
...
func NewCreateSshkeyParam(in Input) (*CreateSshkeyParam, error) {
	v := &CreateSshkeyParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewReadSshkeyParam(in Input) (*ReadSshkeyParam, error) {
	v := &ReadSshkeyParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewUpdateSshkeyParam(in Input) (*UpdateSshkeyParam, error) {
	v := &UpdateSshkeyParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewDeleteSshkeyParam(in Input) (*DeleteSshkeyParam, error) {
	v := &DeleteSshkeyParam{
		input: in,
	}
	if err := v.validate(); err != nil {
...
func NewGenerateSshkeyParam(in Input) (*GenerateSshkeyParam, error) {
	v := &GenerateSshkeyParam{
		input: in,
	}
	if err := v.validate(); err != nil {
		return nil, err
