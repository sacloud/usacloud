...
func (p *clearMessagesParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *clearMessagesParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *clearMessagesParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *clearMessagesParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *clearMessagesParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *clearMessagesParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
