...
func (p *rotateAPIKeyParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *rotateAPIKeyParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *rotateAPIKeyParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *rotateAPIKeyParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *rotateAPIKeyParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *rotateAPIKeyParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
