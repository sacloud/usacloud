...
func (p *countMessagesParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *countMessagesParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *countMessagesParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *countMessagesParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *countMessagesParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *countMessagesParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
