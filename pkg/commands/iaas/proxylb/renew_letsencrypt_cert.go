...
var renewLetsEncryptCertCommand = &core.Command{
	Name:     "renew-lets-encrypt-cert",
	Category: "operation",
	Order:    20,
	...
	ParameterInitializer: func() interface{} {
		return newRenewLetsEncryptCertParameter()
	},
}
...
func init() {
	Resource.AddCommand(renewLetsEncryptCertCommand)
}
