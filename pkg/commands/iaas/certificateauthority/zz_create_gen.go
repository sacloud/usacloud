...
func (p *createParameter) buildFlags(fs *pflag.FlagSet) {
	...
	fs.StringVarP(&p.Country, "country", "", p.Country, "(*required) ")
	fs.StringVarP(&p.Organization, "organization", "", p.Organization, "(*required) ")
	fs.StringSliceVarP(&p.OrganizationUnit, "organization-unit", "", p.OrganizationUnit, "")
	fs.StringVarP(&p.CommonName, "common-name", "", p.CommonName, "(*required) ")
	fs.IntVarP(&p.ValidityPeriodHours, "validity-period-hours", "", p.ValidityPeriodHours, "(*required) ")
	fs.StringVarP(&p.ClientsData, "clients", "", p.ClientsData, "")
...
func (p *createParameter) buildFlagsUsage(cmd *cobra.Command) {
	...
	}
	{
		...
		fs.AddFlag(cmd.LocalFlags().Lookup("country"))
		fs.AddFlag(cmd.LocalFlags().Lookup("organization"))
		fs.AddFlag(cmd.LocalFlags().Lookup("organization-unit"))
		fs.AddFlag(cmd.LocalFlags().Lookup("servers"))
		fs.AddFlag(cmd.LocalFlags().Lookup("validity-period-hours"))
		sets = append(sets, &core.FlagSet{
