...
func (p *ftpOpenParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *ftpOpenParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *ftpOpenParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *ftpOpenParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *ftpOpenParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *ftpOpenParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
