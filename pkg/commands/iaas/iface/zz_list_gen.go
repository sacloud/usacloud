...
func (p *listParameter) buildFlags(fs *pflag.FlagSet) {
	...
	fs.StringSliceVarP(&p.MACAddresses, "mac-addresses", "", p.MACAddresses, "")
	fs.StringSliceVarP(&p.ServerIDs, "server-ids", "", p.ServerIDs, "")
	fs.StringSliceVarP(&p.ServerNames, "server-names", "", p.ServerNames, "")
	fs.StringSliceVarP(&p.PacketFilterIDs, "packet-filer-ids", "", p.PacketFilterIDs, "")
	fs.StringSliceVarP(&p.PacketFilterNames, "packet-filter-names", "", p.PacketFilterNames, "")
