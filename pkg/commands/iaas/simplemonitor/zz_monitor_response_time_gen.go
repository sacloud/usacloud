...
func (p *monitorResponseTimeParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *monitorResponseTimeParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *monitorResponseTimeParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *monitorResponseTimeParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *monitorResponseTimeParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *monitorResponseTimeParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
