...
func (p *createParameter) setCompletionFunc(cmd *cobra.Command) {
	...
	cmd.RegisterFlagCompletionFunc("os-type", util.FlagCompletionFunc("almalinux", "almalinux10", "almalinux9", "almalinux8", "rockylinux", "rockylinux10", "rockylinux9", "rockylinux8", "miracle", "miraclelinux", "miracle9", "miraclelinux9", "miracle8", "miraclelinux8", "ubuntu", "ubuntu2404", "ubuntu2204", "debian", "debian12", "debian11", "kusanagi"))
