...
func (p *disconnectFromServerParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *disconnectFromServerParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *disconnectFromServerParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *disconnectFromServerParameter) buildFlagsUsage(cmd *cobra.Command) {
