...
func (p *listParametersParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *listParametersParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *listParametersParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *listParametersParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *listParametersParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *listParametersParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
