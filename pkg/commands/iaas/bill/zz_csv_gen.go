...
func (p *csvParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *csvParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *csvParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *csvParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *csvParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *csvParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
