...
func (p *rdpParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *rdpParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *rdpParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *rdpParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *rdpParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *rdpParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
