...
func (p *vncParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *vncParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *vncParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *vncParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *vncParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *vncParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
