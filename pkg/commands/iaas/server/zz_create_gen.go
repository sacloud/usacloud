...
func (p *createParameter) buildFlags(fs *pflag.FlagSet) {
	...
	fs.StringVarP(&p.GPUModel, "gpu-model", "", p.GPUModel, "")
	...
	fs.VarP(core.NewIDFlag(&p.Disk.KMSKeyID, &p.Disk.KMSKeyID), "disk-kms-key-id", "", "")
...
func (p *createParameter) buildFlagsUsage(cmd *cobra.Command) {
	...
	}
	{
		...
		fs.AddFlag(cmd.LocalFlags().Lookup("disk-kms-key-id"))
...
func (p *createParameter) setCompletionFunc(cmd *cobra.Command) {
	...
	cmd.RegisterFlagCompletionFunc("disk-os-type", util.FlagCompletionFunc("almalinux", "almalinux10", "almalinux9", "almalinux8", "rockylinux", "rockylinux10", "rockylinux9", "rockylinux8", "miracle", "miraclelinux", "miracle9", "miraclelinux9", "miracle8", "miraclelinux8", "ubuntu", "ubuntu2404", "ubuntu2204", "debian", "debian12", "debian11", "kusanagi"))
