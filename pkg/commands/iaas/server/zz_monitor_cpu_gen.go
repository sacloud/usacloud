...
func (p *monitorCPUParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *monitorCPUParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *monitorCPUParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *monitorCPUParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *monitorCPUParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *monitorCPUParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
