...
func (p *monitorSIMParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *monitorSIMParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *monitorSIMParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *monitorSIMParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *monitorSIMParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *monitorSIMParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
