...
func (p *deleteSubnetParameter) CleanupEmptyValue(fs *pflag.FlagSet) {
...
func (p *deleteSubnetParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *deleteSubnetParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *deleteSubnetParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *deleteSubnetParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
