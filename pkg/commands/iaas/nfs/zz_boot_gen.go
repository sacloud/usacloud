...
func (p *bootParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *bootParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *bootParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *bootParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *bootParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
