...
func (p *createParameter) buildFlags(fs *pflag.FlagSet) {
	...
	fs.StringVarP(&p.TriggerType, "trigger-type", "", p.TriggerType, "options: [cpu/router/schedule]")
	...
	fs.StringVarP(&p.ScheduleScalingData, "schedule-scaling", "", p.ScheduleScalingData, "")
...
func (p *createParameter) buildFlagsUsage(cmd *cobra.Command) {
	...
	}
	{
		...
		fs.SortFlags = false
		fs.AddFlag(cmd.LocalFlags().Lookup("api-key-id"))
