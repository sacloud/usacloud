...
func (p *healthParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *healthParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *healthParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *healthParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *healthParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *healthParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
