...
func (p *updateParameter) buildFlags(fs *pflag.FlagSet) {
	...
	fs.StringVarP(p.Settings, "settings", "", "", "Trigger settings JSON or file path; see command help for fields and examples")
