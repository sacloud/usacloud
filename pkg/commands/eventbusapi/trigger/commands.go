...
var triggerOpFactory = func(ctx cli.Context) (eventbus.TriggerAPI, error) {
...
const triggerSettingsHelp = `Trigger settings are a JSON object or a path to a JSON file.
...
Optional fields:
  ...
  Conditions  Array of event conditions`

var listCommand = &core.Command{
	Name:       "list",
	Aliases:    []string{"ls", "find", "select"},
	Usage:      "List EventBus triggers",
	Category:   "basic",
	Order:      10,
	NoProgress: true,
...
var createCommand = &core.Command{
	Name:      "create",
	Usage:     "Create an EventBus trigger",
	LongUsage: "Create an EventBus trigger.\n\n" + triggerSettingsHelp,
	Example:   `  usacloud eventbus-api trigger create --name created-events --settings '{"Source":"//example/source","Types":["example.created"],"ProcessConfigurationID":"pc-id"}' -y`,
	Category:  "basic",
	Order:     20,
...
type createParameter struct {
	...
	Settings string `cli:"settings,desc=Trigger settings JSON or file path; see command help for fields and examples" validate:"required" mapconv:"-" json:"-"`
}
...
var readCommand = &core.Command{
	Name:         "read",
	Aliases:      []string{"show"},
	Usage:        "Read an EventBus trigger",
	Category:     "basic",
	Order:        30,
	NoProgress:   true,
...
var updateCommand = &core.Command{
	Name:         "update",
	Usage:        "Update EventBus triggers",
	LongUsage:    "Update one or more EventBus triggers.\n\n" + triggerSettingsHelp,
	Example:      `  usacloud eventbus-api trigger update trigger-id --settings '{"Source":"//example/source","Types":["example.updated"],"ProcessConfigurationID":"pc-id"}' -y`,
	Category:     "basic",
	Order:        40,
...
type updateParameter struct {
	...
	Settings         *string `cli:"settings,desc=Trigger settings JSON or file path; see command help for fields and examples" mapconv:"-" json:"-"`
}
...
var deleteCommand = &core.Command{
	Name:         "delete",
	Aliases:      []string{"rm"},
	Usage:        "Delete EventBus triggers",
	Category:     "basic",
	Order:        50,
	SelectorType: core.SelectorTypeRequireMulti,
	ParameterInitializer: func() interface{} {
...
func createRequest(p *createParameter) (v1.CreateCommonServiceItemRequest, error) {
	settings, err := triggerSettings(p.Settings)
	if err != nil {
	...
	return v1.CreateCommonServiceItemRequest{
		CommonServiceItem: v1.CreateCommonServiceItemRequestCommonServiceItem{
			...
			Tags:        p.Tags,
			Settings:    v1.NewTriggerSettingsSettings(settings),
			Provider:    v1.Provider{Class: v1.ProviderClassEventbustrigger},
		},
	}, nil
}
...
func updateRequest(p *updateParameter) (v1.UpdateCommonServiceItemRequest, error) {
	item := v1.UpdateCommonServiceItemRequestCommonServiceItem{
		Provider: v1.NewOptProvider(v1.Provider{Class: v1.ProviderClassEventbustrigger}),
	}
	if p.Name != nil {
	...
	if p.Settings != nil {
		...
		item.Settings = v1.NewOptSettings(v1.NewTriggerSettingsSettings(settings))
	}
	return v1.UpdateCommonServiceItemRequest{CommonServiceItem: item}, nil
}

func triggerSettings(data string) (v1.TriggerSettings, error) {
	var settings v1.TriggerSettings
	if err := common.DecodeJSONPathOrContent(data, &settings); err != nil {
		return v1.TriggerSettings{}, err
	}
	return settings, nil
}
