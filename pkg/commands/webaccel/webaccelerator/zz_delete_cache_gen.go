...
func (p *deleteCacheParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *deleteCacheParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *deleteCacheParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *deleteCacheParameter) buildFlagsUsage(cmd *cobra.Command) {
	var sets []*core.FlagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("web-accelerator", pflag.ContinueOnError)
		fs.SortFlags = false
		fs.AddFlag(cmd.LocalFlags().Lookup("url"))
...
func (p *deleteCacheParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *deleteCacheParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
