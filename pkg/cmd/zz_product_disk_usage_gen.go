...
func productDiskCommandOrder(cmd *cobra.Command) []*commandSet {
...
func productDiskListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func productDiskReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
