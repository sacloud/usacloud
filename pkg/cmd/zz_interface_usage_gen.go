...
func interfaceCommandOrder(cmd *cobra.Command) []*commandSet {
	...
	}
	{
		...
		set.commands = append(set.commands, lookupCmd(cmd, "packet-filter-connect"))
		set.commands = append(set.commands, lookupCmd(cmd, "packet-filter-disconnect"))
		commands = append(commands, set)
	}
...
func interfaceListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func interfacePacketFilterConnectFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("packet-filter", pflag.ContinueOnError)
		fs.AddFlag(cmd.LocalFlags().Lookup("packet-filter-id"))
		sets = append(sets, &flagSet{
			title: "Packet-Filter options",
			flags: fs,
		})
	}
	{
...
func interfaceCreateFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
...
func interfacePacketFilterDisconnectFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("packet-filter", pflag.ContinueOnError)
...
func interfaceReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
...
func interfaceUpdateFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("interface", pflag.ContinueOnError)
		fs.AddFlag(cmd.LocalFlags().Lookup("user-ipaddress"))
		sets = append(sets, &flagSet{
			title: "Interface options",
			flags: fs,
		})
...
func interfaceDeleteFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
