...
func findGSLBServerAddTargets(ctx cli.Context, param *params.ServerAddGSLBParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().GSLB
...
func findGSLBReadTargets(ctx cli.Context, param *params.ReadGSLBParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().GSLB
...
func findGSLBServerUpdateTargets(ctx cli.Context, param *params.ServerUpdateGSLBParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().GSLB
...
func findGSLBServerDeleteTargets(ctx cli.Context, param *params.ServerDeleteGSLBParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().GSLB
...
func findGSLBUpdateTargets(ctx cli.Context, param *params.UpdateGSLBParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().GSLB
...
func findGSLBDeleteTargets(ctx cli.Context, param *params.DeleteGSLBParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().GSLB
