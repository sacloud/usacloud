...
func findLicenseUpdateTargets(ctx cli.Context, param *params.UpdateLicenseParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().License
...
func findLicenseDeleteTargets(ctx cli.Context, param *params.DeleteLicenseParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().License
