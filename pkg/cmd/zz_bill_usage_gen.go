...
func billCommandOrder(cmd *cobra.Command) []*commandSet {
	var commands []*commandSet
	{
		set := &commandSet{
			title: "",
		}
		set.commands = append(set.commands, lookupCmd(cmd, "csv"))
...
func billCsvFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
	...
	}
	{
		...
		fs.AddFlag(cmd.LocalFlags().Lookup("no-header"))
		fs.AddFlag(cmd.LocalFlags().Lookup("bill-output"))
		sets = append(sets, &flagSet{
	...
	}
	{
		...
		fs.AddFlag(cmd.LocalFlags().Lookup("bill-id"))
		sets = append(sets, &flagSet{
			title: "Other options",
			flags: fs,
		})
...
func billListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("filter", pflag.ContinueOnError)
		fs.AddFlag(cmd.LocalFlags().Lookup("year"))
		fs.AddFlag(cmd.LocalFlags().Lookup("month"))
		sets = append(sets, &flagSet{
