...
func findInterfacePacketFilterDisconnectTargets(ctx cli.Context, param *params.PacketFilterDisconnectInterfaceParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Interface
...
func findInterfaceReadTargets(ctx cli.Context, param *params.ReadInterfaceParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Interface
...
func findInterfaceUpdateTargets(ctx cli.Context, param *params.UpdateInterfaceParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Interface
...
func findInterfaceDeleteTargets(ctx cli.Context, param *params.DeleteInterfaceParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Interface
