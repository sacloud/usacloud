...
func findDNSRecordBulkUpdateTargets(ctx cli.Context, param *params.RecordBulkUpdateDNSParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().DNS
...
func findDNSRecordAddTargets(ctx cli.Context, param *params.RecordAddDNSParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().DNS
...
func findDNSReadTargets(ctx cli.Context, param *params.ReadDNSParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().DNS
...
func findDNSRecordUpdateTargets(ctx cli.Context, param *params.RecordUpdateDNSParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().DNS
...
func findDNSRecordDeleteTargets(ctx cli.Context, param *params.RecordDeleteDNSParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().DNS
...
func findDNSUpdateTargets(ctx cli.Context, param *params.UpdateDNSParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().DNS
...
func findDNSDeleteTargets(ctx cli.Context, param *params.DeleteDNSParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().DNS
