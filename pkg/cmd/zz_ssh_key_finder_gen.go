...
func findSSHKeyUpdateTargets(ctx cli.Context, param *params.UpdateSSHKeyParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().SSHKey
...
func findSSHKeyDeleteTargets(ctx cli.Context, param *params.DeleteSSHKeyParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().SSHKey
