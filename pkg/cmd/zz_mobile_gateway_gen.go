...
func mobileGatewayListCmd() *cobra.Command {
	...
	fs.StringSliceVarP(&mobileGatewayListParam.Tags, "tags", "", []string{}, "set filter by tags(AND) (aliases: selector)")
	fs.IntVarP(&mobileGatewayListParam.From, "from", "", 0, "set offset (aliases: offset)")
	fs.IntVarP(&mobileGatewayListParam.Max, "max", "", 0, "set limit (aliases: limit)")
	...
	fs.StringVarP(&mobileGatewayListParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayListParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayListParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayListParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewayCreateCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewayCreateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&mobileGatewayCreateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayCreateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayCreateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayCreateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewayReadCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewayReadParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayReadParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayReadParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayReadParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewayUpdateCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewayUpdateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&mobileGatewayUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewayDeleteCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewayDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewayInterfaceInfoCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewayInterfaceInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayInterfaceInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayInterfaceInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayInterfaceInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewayInterfaceConnectCmd() *cobra.Command {
	...
	fs := cmd.Flags()
	fs.StringVarP(&mobileGatewayInterfaceConnectParam.Ipaddress, "ipaddress", "", "", "set ipaddress (aliases: ip)")
	fs.VarP(newIDValue(0, &mobileGatewayInterfaceConnectParam.SwitchId), "switch-id", "", "set connect switch ID")
	fs.IntVarP(&mobileGatewayInterfaceConnectParam.NwMasklen, "nw-masklen", "", 24, "set ipaddress prefix (aliases: network-masklen)")
...
func mobileGatewayInterfaceUpdateCmd() *cobra.Command {
	...
	fs := cmd.Flags()
	fs.StringVarP(&mobileGatewayInterfaceUpdateParam.Ipaddress, "ipaddress", "", "", "set ipaddress (aliases: ip)")
	fs.IntVarP(&mobileGatewayInterfaceUpdateParam.NwMasklen, "nw-masklen", "", 24, "set ipaddress prefix (aliases: network-masklen)")
...
func mobileGatewayTrafficControlInfoCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewayTrafficControlInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayTrafficControlInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayTrafficControlInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayTrafficControlInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewayTrafficControlEnableParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("traffic-control-enable", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewayTrafficControlUpdateParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("traffic-control-update", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewayTrafficControlDisableParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("traffic-control-disable", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
...
func mobileGatewayStaticRouteInfoCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewayStaticRouteInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewayStaticRouteInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewayStaticRouteInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewayStaticRouteInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewaySIMInfoCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewaySIMInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewaySIMInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewaySIMInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewaySIMInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func mobileGatewaySIMAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewaySIMAddParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("sim-add", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
	...
	fs := cmd.Flags()
	fs.StringVarP(&mobileGatewaySIMAddParam.Ipaddress, "ipaddress", "", "", "set ipaddress (aliases: ip)")
...
func mobileGatewaySIMUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewaySIMUpdateParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("sim-update", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
	...
	fs := cmd.Flags()
	fs.StringVarP(&mobileGatewaySIMUpdateParam.Ipaddress, "ipaddress", "", "", "set ipaddress (aliases: ip)")
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewaySIMDeleteParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("sim-delete", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
...
func mobileGatewaySIMRouteInfoCmd() *cobra.Command {
	...
	fs.StringVarP(&mobileGatewaySIMRouteInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&mobileGatewaySIMRouteInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&mobileGatewaySIMRouteInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&mobileGatewaySIMRouteInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewaySIMRouteAddParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("sim-route-add", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewaySIMRouteUpdateParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("sim-route-update", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewaySIMRouteDeleteParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("sim-route-delete", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !mobileGatewayDNSUpdateParam.Assumeyes {
				...
				result, err := util.ConfirmContinue("dns-update", ctx.IO().In(), ctx.IO().Out(), ids...)
				if err != nil || !result {
					return err
				}
			}
