...
var monitorFreeDiskSizeCommand = &core.Command{
	...
	ParameterInitializer: func() interface{} {
		return newMonitorFreeDiskSizeParameter()
	},
}

type monitorFreeDiskSizeParameter struct {
...
func init() {
	Resource.AddCommand(monitorFreeDiskSizeCommand)
}
