...
func (p *monitorFreeDiskSizeParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *monitorFreeDiskSizeParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *monitorFreeDiskSizeParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *monitorFreeDiskSizeParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *monitorFreeDiskSizeParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *monitorFreeDiskSizeParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
