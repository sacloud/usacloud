...
func (p *listSubnetParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *listSubnetParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *listSubnetParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *listSubnetParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *listSubnetParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *listSubnetParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
