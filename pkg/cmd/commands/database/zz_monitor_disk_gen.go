...
func (p *monitorDiskParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *monitorDiskParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *monitorDiskParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *monitorDiskParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *monitorDiskParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *monitorDiskParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
