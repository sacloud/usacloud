...
func (p *monitorDatabaseParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *monitorDatabaseParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *monitorDatabaseParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *monitorDatabaseParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *monitorDatabaseParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *monitorDatabaseParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
