...
func (p *readCertificateParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *readCertificateParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *readCertificateParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *readCertificateParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *readCertificateParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *readCertificateParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
