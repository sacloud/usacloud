...
func (p *logsParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *logsParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *logsParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *logsParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *logsParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *logsParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
