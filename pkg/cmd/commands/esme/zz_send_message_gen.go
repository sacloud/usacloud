...
func (p *sendMessageParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *sendMessageParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *sendMessageParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *sendMessageParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *sendMessageParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *sendMessageParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
