...
func (p *updateCertificateParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *updateCertificateParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *updateCertificateParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *updateCertificateParameter) buildFlagsUsage(cmd *cobra.Command) {
	var sets []*core.FlagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("web-accelerator", pflag.ContinueOnError)
		fs.SortFlags = false
		fs.AddFlag(cmd.LocalFlags().Lookup("certificate-chain"))
		fs.AddFlag(cmd.LocalFlags().Lookup("key"))
		sets = append(sets, &core.FlagSet{
			Title: "Web-Accelerator-specific options",
			Flags: fs,
		})
	}
	{
...
func (p *updateCertificateParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *updateCertificateParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
