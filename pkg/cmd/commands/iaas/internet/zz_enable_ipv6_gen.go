...
func (p *enableIPv6Parameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *enableIPv6Parameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *enableIPv6Parameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *enableIPv6Parameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *enableIPv6Parameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *enableIPv6Parameter) SetupCobraCommandFlags(cmd *cobra.Command) {
