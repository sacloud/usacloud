...
func (p *generateParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *generateParameter) buildFlags(fs *pflag.FlagSet) {
	...
	fs.StringVarP(&p.PassPhrase, "pass-phrase", "", p.PassPhrase, "")
	fs.SetNormalizeFunc(p.normalizeFlagName)
}

func (p *generateParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *generateParameter) buildFlagsUsage(cmd *cobra.Command) {
	...
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("ssh-key", pflag.ContinueOnError)
		fs.SortFlags = false
		fs.AddFlag(cmd.LocalFlags().Lookup("pass-phrase"))
		sets = append(sets, &core.FlagSet{
			Title: "Ssh-Key-specific options",
			Flags: fs,
		})
	}
	{
...
func (p *generateParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *generateParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
