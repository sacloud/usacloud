...
func (p *updateHostNameParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *updateHostNameParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *updateHostNameParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *updateHostNameParameter) buildFlagsUsage(cmd *cobra.Command) {
	var sets []*core.FlagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("ipaddress", pflag.ContinueOnError)
		fs.SortFlags = false
		...
		fs.AddFlag(cmd.LocalFlags().Lookup("retry-max"))
		sets = append(sets, &core.FlagSet{
			Title: "Ipaddress-specific options",
			Flags: fs,
		})
	}
	{
...
func (p *updateHostNameParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *updateHostNameParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
