...
func (p *monitorConnectionParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *monitorConnectionParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *monitorConnectionParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *monitorConnectionParameter) buildFlagsUsage(cmd *cobra.Command) {
...
func (p *monitorConnectionParameter) setCompletionFunc(cmd *cobra.Command) {

}

func (p *monitorConnectionParameter) SetupCobraCommandFlags(cmd *cobra.Command) {
