...
func (p *createParameter) buildFlags(fs *pflag.FlagSet) {
	...
	fs.StringVarP(&p.Target, "target", "", p.Target, "")
	...
	fs.StringVarP(&p.HealthCheck.Protocol, "health-check-protocol", "", p.HealthCheck.Protocol, "options: [http/https/ping/tcp/dns/ssh/smtp/pop3/snmp/sslcertificate]")
