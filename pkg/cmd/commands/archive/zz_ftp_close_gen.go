...
func (p *ftpCloseParameter) CleanupEmptyValue(fs *pflag.FlagSet) {

}

func (p *ftpCloseParameter) buildFlags(fs *pflag.FlagSet) {
...
func (p *ftpCloseParameter) normalizeFlagName(_ *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "skeleton":
...
func (p *ftpCloseParameter) buildFlagsUsage(cmd *cobra.Command) {
