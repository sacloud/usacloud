...
func (p *updateParameter) CleanupEmptyValue(fs *pflag.FlagSet) {
	...
	if !fs.Changed("public-network-interface-ip-addresses") {
		p.PublicNetworkInterface.IPAddresses = nil
	}
	if !fs.Changed("public-network-interface-virtual-ip-address") {
		p.PublicNetworkInterface.VirtualIPAddress = nil
	}
	if !fs.Changed("public-network-interface-ip-aliases") {
		p.PublicNetworkInterface.IPAliases = nil
	}
...
func (p *updateParameter) buildFlags(fs *pflag.FlagSet) {
	...
	if p.PublicNetworkInterface.VirtualIPAddress == nil {
		p.PublicNetworkInterface.VirtualIPAddress = pointer.NewString("")
	}
	if p.PublicNetworkInterface.IPAliases == nil {
		p.PublicNetworkInterface.IPAliases = pointer.NewStringSlice([]string{})
	}
	...
	fs.StringSliceVarP(p.PublicNetworkInterface.IPAddresses, "public-network-interface-ip-addresses", "", nil, "")
	fs.StringVarP(p.PublicNetworkInterface.VirtualIPAddress, "public-network-interface-virtual-ip-address", "", "", "")
	fs.StringSliceVarP(p.PublicNetworkInterface.IPAliases, "public-network-interface-ip-aliases", "", nil, "")
