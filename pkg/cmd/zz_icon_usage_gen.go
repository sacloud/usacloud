...
func iconCommandOrder(cmd *cobra.Command) []*commandSet {
...
func iconListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func iconCreateFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("icon", pflag.ContinueOnError)
		fs.AddFlag(cmd.LocalFlags().Lookup("image"))
		sets = append(sets, &flagSet{
			title: "Icon options",
			flags: fs,
		})
...
func iconReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("filter", pflag.ContinueOnError)
...
func iconUpdateFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("filter", pflag.ContinueOnError)
...
func iconDeleteFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("filter", pflag.ContinueOnError)
