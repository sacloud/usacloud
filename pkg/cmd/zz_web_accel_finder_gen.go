...
func findWebAccelReadTargets(ctx cli.Context, param *params.ReadWebAccelParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
...
func findWebAccelCertificateInfoTargets(ctx cli.Context, param *params.CertificateInfoWebAccelParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().WebAccel
...
func findWebAccelCertificateNewTargets(ctx cli.Context, param *params.CertificateNewWebAccelParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().WebAccel
...
func findWebAccelCertificateUpdateTargets(ctx cli.Context, param *params.CertificateUpdateWebAccelParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().WebAccel
