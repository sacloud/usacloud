...
func findSwitchReadTargets(ctx cli.Context, param *params.ReadSwitchParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
...
func findSwitchUpdateTargets(ctx cli.Context, param *params.UpdateSwitchParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Switch
...
func findSwitchDeleteTargets(ctx cli.Context, param *params.DeleteSwitchParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Switch
...
func findSwitchBridgeConnectTargets(ctx cli.Context, param *params.BridgeConnectSwitchParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Switch
...
func findSwitchBridgeDisconnectTargets(ctx cli.Context, param *params.BridgeDisconnectSwitchParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Switch
