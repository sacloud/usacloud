...
func productLicenseCommandOrder(cmd *cobra.Command) []*commandSet {
...
func productLicenseListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func productLicenseReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
