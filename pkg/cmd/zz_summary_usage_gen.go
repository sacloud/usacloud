...
func summaryCommandOrder(cmd *cobra.Command) []*commandSet {
...
func summaryShowFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
	...
	}
	{
		...
		fs.AddFlag(cmd.LocalFlags().Lookup("paid-resources-only"))
		sets = append(sets, &flagSet{
			title: "Other options",
			flags: fs,
		})
