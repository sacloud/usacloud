...
func findPrivateHostReadTargets(ctx cli.Context, param *params.ReadPrivateHostParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
...
func findPrivateHostUpdateTargets(ctx cli.Context, param *params.UpdatePrivateHostParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().PrivateHost
...
func findPrivateHostDeleteTargets(ctx cli.Context, param *params.DeletePrivateHostParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().PrivateHost
...
func findPrivateHostServerInfoTargets(ctx cli.Context, param *params.ServerInfoPrivateHostParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().PrivateHost
...
func findPrivateHostServerAddTargets(ctx cli.Context, param *params.ServerAddPrivateHostParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().PrivateHost
...
func findPrivateHostServerDeleteTargets(ctx cli.Context, param *params.ServerDeletePrivateHostParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().PrivateHost
