...
func productServerCommandOrder(cmd *cobra.Command) []*commandSet {
...
func productServerListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func productServerReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
