...
func findISOImageReadTargets(ctx cli.Context, param *params.ReadISOImageParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
...
func findISOImageUpdateTargets(ctx cli.Context, param *params.UpdateISOImageParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().CDROM
...
func findISOImageDeleteTargets(ctx cli.Context, param *params.DeleteISOImageParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().CDROM
...
func findISOImageUploadTargets(ctx cli.Context, param *params.UploadISOImageParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().CDROM
...
func findISOImageDownloadTargets(ctx cli.Context, param *params.DownloadISOImageParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().CDROM
...
func findISOImageFTPOpenTargets(ctx cli.Context, param *params.FTPOpenISOImageParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().CDROM
...
func findISOImageFTPCloseTargets(ctx cli.Context, param *params.FTPCloseISOImageParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().CDROM
