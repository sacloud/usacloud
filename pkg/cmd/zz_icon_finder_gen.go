...
func findIconReadTargets(ctx cli.Context, param *params.ReadIconParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
...
func findIconUpdateTargets(ctx cli.Context, param *params.UpdateIconParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Icon
...
func findIconDeleteTargets(ctx cli.Context, param *params.DeleteIconParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().Icon
