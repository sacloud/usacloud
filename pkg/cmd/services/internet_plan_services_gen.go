...
import (
	service "github.com/sacloud/libsacloud/v2/helper/service/internetplan"
...
func init() {
	setDefaultServiceFunc("internet-plan", "list",
	...
	setDefaultListAllFunc("internet-plan", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
	...
	setDefaultServiceFunc("internet-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
	...
	setDefaultListAllFunc("internet-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
			res, err := svc.FindWithContext(ctx, &service.FindRequest{Zone: (parameter.(cflag.ZoneParameterValueHandler)).ZoneFlagValue()})
			if err != nil {
