...
import (
	service "github.com/sacloud/libsacloud/v2/helper/service/iface"
...
func init() {
	setDefaultServiceFunc("interface", "list",
	...
	setDefaultListAllFunc("interface", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
	...
	setDefaultServiceFunc("interface", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
	...
	setDefaultListAllFunc("interface", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
			res, err := svc.FindWithContext(ctx, &service.FindRequest{Zone: (parameter.(cflag.ZoneParameterValueHandler)).ZoneFlagValue()})
			if err != nil {
