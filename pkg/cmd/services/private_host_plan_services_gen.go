...
import (
	service "github.com/sacloud/libsacloud/v2/helper/service/privatehostplan"
...
func init() {
	setDefaultServiceFunc("private-host-plan", "list",
	...
	setDefaultListAllFunc("private-host-plan", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
	...
	setDefaultServiceFunc("private-host-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
	...
	setDefaultListAllFunc("private-host-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client())
			res, err := svc.FindWithContext(ctx, &service.FindRequest{Zone: (parameter.(cflag.ZoneParameterValueHandler)).ZoneFlagValue()})
			if err != nil {
