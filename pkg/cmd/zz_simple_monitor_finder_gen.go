...
func findSimpleMonitorReadTargets(ctx cli.Context, param *params.ReadSimpleMonitorParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
...
func findSimpleMonitorUpdateTargets(ctx cli.Context, param *params.UpdateSimpleMonitorParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().SimpleMonitor
...
func findSimpleMonitorDeleteTargets(ctx cli.Context, param *params.DeleteSimpleMonitorParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().SimpleMonitor
...
func findSimpleMonitorHealthTargets(ctx cli.Context, param *params.HealthSimpleMonitorParam) ([]sacloud.ID, error) {
	var ids []sacloud.ID
	args := ctx.Args()
	apiClient := ctx.GetAPIClient().SimpleMonitor
