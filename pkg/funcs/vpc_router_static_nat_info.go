...
func VPCRouterStaticNatInfo(ctx cli.Context, params *params.StaticNatInfoVPCRouterParam) error {
	...
	if !p.HasStaticNAT() {
		fmt.Fprintf(ctx.IO().Err(), "VPCRouter[%d] don't have any static NAT settings\n", params.Id)
		return nil
	}
