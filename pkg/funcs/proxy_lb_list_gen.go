...
func ProxyLBList(ctx cli.Context, params *params.ListProxyLBParam) error {
	...
	for i := range res.CommonServiceProxyLBItems {
		...
		if !params.GetCommandDef().Params["tags"].FilterFunc(list, &res.CommonServiceProxyLBItems[i], params.Tags) {
			continue
		}

		list = append(list, &res.CommonServiceProxyLBItems[i])
	}
