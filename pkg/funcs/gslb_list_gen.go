...
func GSLBList(ctx cli.Context, params *params.ListGSLBParam) error {
	...
	for i := range res.CommonServiceGSLBItems {
		...
		if !params.GetCommandDef().Params["tags"].FilterFunc(list, &res.CommonServiceGSLBItems[i], params.Tags) {
			continue
		}
