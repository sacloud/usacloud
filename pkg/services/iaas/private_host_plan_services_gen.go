...
import (
	...
	service "github.com/sacloud/sacloud-sdk-go/service/iaas/privatehostplan"
...
func init() {
	registry.SetDefaultServiceFunc("iaas", "private-host-plan", "list",
	...
	registry.SetDefaultListAllFunc("iaas", "private-host-plan", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultServiceFunc("iaas", "private-host-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "private-host-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{Zone: (parameter.(cflag.ZoneParameterValueHandler)).ZoneFlagValue()}
