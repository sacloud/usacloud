...
import (
	...
	service "github.com/sacloud/sacloud-sdk-go/service/iaas/sim"
...
func init() {
	...
	registry.SetDefaultListAllFunc("iaas", "sim", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "sim", "create",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "sim", "create",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "sim", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "sim", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "sim", "update",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "sim", "update",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "sim", "delete",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultServiceFunc("iaas", "sim", "monitor-sim",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "sim", "monitor-sim",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "sim", "logs",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "sim", "logs",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
