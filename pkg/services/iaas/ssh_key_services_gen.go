...
import (
	...
	service "github.com/sacloud/sacloud-sdk-go/service/iaas/sshkey"
...
func init() {
	registry.SetDefaultServiceFunc("iaas", "ssh-key", "list",
	...
	registry.SetDefaultListAllFunc("iaas", "ssh-key", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "ssh-key", "create",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "ssh-key", "create",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultListAllFunc("iaas", "ssh-key", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "ssh-key", "update",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "ssh-key", "update",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "ssh-key", "delete",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "ssh-key", "delete",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
