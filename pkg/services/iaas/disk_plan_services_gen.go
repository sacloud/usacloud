...
import (
	...
	service "github.com/sacloud/sacloud-sdk-go/service/iaas/diskplan"
...
func init() {
	registry.SetDefaultServiceFunc("iaas", "disk-plan", "list",
	...
	registry.SetDefaultListAllFunc("iaas", "disk-plan", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultServiceFunc("iaas", "disk-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "disk-plan", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{Zone: (parameter.(cflag.ZoneParameterValueHandler)).ZoneFlagValue()}
