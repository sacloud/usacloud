...
import (
	...
	service "github.com/sacloud/sacloud-sdk-go/service/iaas/licenseinfo"
...
func init() {
	registry.SetDefaultServiceFunc("iaas", "license-info", "list",
	...
	registry.SetDefaultListAllFunc("iaas", "license-info", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "license-info", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "license-info", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
