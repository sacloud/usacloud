...
import (
	...
	service "github.com/sacloud/sacloud-sdk-go/service/iaas/region"
...
func init() {
	registry.SetDefaultServiceFunc("iaas", "region", "list",
	...
	registry.SetDefaultListAllFunc("iaas", "region", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
	...
	registry.SetDefaultServiceFunc("iaas", "region", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
	...
	registry.SetDefaultListAllFunc("iaas", "region", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(iaas.APICaller))
			req := &service.FindRequest{}
