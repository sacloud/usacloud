...
import (
	...
	service "github.com/sacloud/phy-service-go/server/port"
...
func init() {
	registry.SetDefaultServiceFunc("phy", "server_port", "list",
	...
	registry.SetDefaultListAllFunc("phy", "server_port", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(*phy.Client))
	...
	registry.SetDefaultServiceFunc("phy", "server_port", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(*phy.Client))
	...
	registry.SetDefaultListAllFunc("phy", "server_port", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(*phy.Client))
			res, err := svc.FindWithContext(ctx, &service.FindRequest{})
			if err != nil {
