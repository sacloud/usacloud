...
import (
	...
	service "github.com/sacloud/phy-service-go/service"
...
func init() {
	registry.SetDefaultServiceFunc("phy", "service", "list",
	...
	registry.SetDefaultListAllFunc("phy", "service", "list",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(*phy.Client))
	...
	registry.SetDefaultServiceFunc("phy", "service", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(*phy.Client))
	...
	registry.SetDefaultListAllFunc("phy", "service", "read",
		func(ctx cli.Context, parameter interface{}) ([]interface{}, error) {
			svc := service.New(ctx.Client().(*phy.Client))
			res, err := svc.FindWithContext(ctx, &service.FindRequest{})
			if err != nil {
