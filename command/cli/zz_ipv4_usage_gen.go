...
func ipv4CommandOrder(cmd *cobra.Command) []*commandSet {
...
func ipv4ListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func ipv4PtrAddFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("ipv4", pflag.ContinueOnError)
...
func ipv4PtrReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
...
func ipv4PtrUpdateFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("ipv4", pflag.ContinueOnError)
...
func ipv4PtrDeleteFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
