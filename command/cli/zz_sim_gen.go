...
func simListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simListParam)
			if err != nil {
				return err
			}
...
func simCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simCreateParam)
			if err != nil {
				return err
			}
...
func simReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simReadParam)
			if err != nil {
				return err
			}
...
func simUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simUpdateParam)
			if err != nil {
				return err
			}
...
func simDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simDeleteParam)
			if err != nil {
				return err
			}
...
func simCarrierInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simCarrierInfoParam)
			if err != nil {
				return err
			}
...
func simCarrierUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simCarrierUpdateParam)
			if err != nil {
				return err
			}
...
func simActivateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simActivateParam)
			if err != nil {
				return err
			}
...
func simDeactivateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simDeactivateParam)
			if err != nil {
				return err
			}
...
func simImeiLockCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simImeiLockParam)
			if err != nil {
				return err
			}
...
func simIpAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simIpAddParam)
			if err != nil {
				return err
			}
...
func simImeiUnlockCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simImeiUnlockParam)
			if err != nil {
				return err
			}
...
func simIpDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simIpDeleteParam)
			if err != nil {
				return err
			}
...
func simLogsCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simLogsParam)
			if err != nil {
				return err
			}
...
func simMonitorCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simMonitorParam)
			if err != nil {
				return err
			}
