...
func packetFilterListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterListParam)
			if err != nil {
				return err
			}
	...
	fs.IntVarP(&packetFilterListParam.From, "from", "", 0, "set offset (aliases: offset)")
	fs.IntVarP(&packetFilterListParam.Max, "max", "", 0, "set limit (aliases: limit)")
	...
	fs.StringVarP(&packetFilterListParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterListParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterListParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterListParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterCreateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterCreateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&packetFilterCreateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterCreateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterCreateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterCreateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterReadParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterReadParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterReadParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterReadParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterReadParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterUpdateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterUpdateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&packetFilterUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterRuleInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterRuleInfoParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterRuleInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterRuleInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterRuleInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterRuleInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterRuleAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterRuleAddParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterRuleAddParam.DestinationPort, "destination-port", "", "", "set destination port[N (N=0..65535)] or [N-N (N=0..65535)] or [0xPPPP/0xMMMM] (aliases: dest-port)")
	fs.StringVarP(&packetFilterRuleAddParam.Action, "action", "", "", "set action[allow/deny]")
	fs.StringVarP(&packetFilterRuleAddParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&packetFilterRuleAddParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterRuleAddParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterRuleAddParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterRuleAddParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterRuleUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterRuleUpdateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterRuleUpdateParam.DestinationPort, "destination-port", "", "", "set destination port[N (N=0..65535)] or [N-N (N=0..65535)] or [0xPPPP/0xMMMM] (aliases: dest-port)")
	fs.StringVarP(&packetFilterRuleUpdateParam.Action, "action", "", "", "set action[allow/deny]")
	fs.StringVarP(&packetFilterRuleUpdateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&packetFilterRuleUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterRuleUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterRuleUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterRuleUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterRuleDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterRuleDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&packetFilterRuleDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&packetFilterRuleDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&packetFilterRuleDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&packetFilterRuleDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func packetFilterInterfaceConnectCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterInterfaceConnectParam)
			if err != nil {
				return err
			}
...
func packetFilterInterfaceDisconnectCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, packetFilterInterfaceDisconnectParam)
			if err != nil {
				return err
			}
