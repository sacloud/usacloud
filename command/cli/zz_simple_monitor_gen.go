...
func simpleMonitorListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simpleMonitorListParam)
			if err != nil {
				return err
			}
...
func simpleMonitorCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simpleMonitorCreateParam)
			if err != nil {
				return err
			}
...
func simpleMonitorReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simpleMonitorReadParam)
			if err != nil {
				return err
			}
...
func simpleMonitorUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simpleMonitorUpdateParam)
			if err != nil {
				return err
			}
...
func simpleMonitorDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simpleMonitorDeleteParam)
			if err != nil {
				return err
			}
...
func simpleMonitorHealthCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, simpleMonitorHealthParam)
			if err != nil {
				return err
			}
