...
func ipv4ListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, ipv4ListParam)
			if err != nil {
				return err
			}
...
func ipv4PtrAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, ipv4PtrAddParam)
			if err != nil {
				return err
			}
...
func ipv4PtrReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, ipv4PtrReadParam)
			if err != nil {
				return err
			}
...
func ipv4PtrUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, ipv4PtrUpdateParam)
			if err != nil {
				return err
			}
...
func ipv4PtrDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, ipv4PtrDeleteParam)
			if err != nil {
				return err
			}
