...
func databaseListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseListParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseListParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseListParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseListParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseCreateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&databaseCreateParam.Database, "database", "", "", "set database type[postgresql/mariadb] (aliases: db)")
	...
	fs.StringVarP(&databaseCreateParam.Ipaddress1, "ipaddress-1", "", "", "set ipaddress(#1) (aliases: ip1, ipaddress, ip)")
	...
	fs.StringVarP(&databaseCreateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringSliceVarP(&databaseCreateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseCreateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseCreateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseReadParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseReadParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseReadParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseReadParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseUpdateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&databaseUpdateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringSliceVarP(&databaseUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseBootCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseBootParam)
			if err != nil {
				return err
			}
...
func databaseShutdownCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseShutdownParam)
			if err != nil {
				return err
			}
...
func databaseShutdownForceCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseShutdownForceParam)
			if err != nil {
				return err
			}
...
func databaseResetCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseResetParam)
			if err != nil {
				return err
			}
...
func databaseWaitForBootCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseWaitForBootParam)
			if err != nil {
				return err
			}
...
func databaseWaitForDownCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseWaitForDownParam)
			if err != nil {
				return err
			}
...
func databaseBackupInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseBackupInfoParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseBackupInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseBackupInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseBackupInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseBackupCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseBackupCreateParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseBackupCreateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseBackupCreateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseBackupCreateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseBackupRestoreCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseBackupRestoreParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseBackupRestoreParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseBackupRestoreParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseBackupRestoreParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseBackupLockCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseBackupLockParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseBackupLockParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseBackupLockParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseBackupLockParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseBackupUnlockCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseBackupUnlockParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseBackupUnlockParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseBackupUnlockParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseBackupUnlockParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseBackupRemoveCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseBackupRemoveParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseBackupRemoveParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseBackupRemoveParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseBackupRemoveParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseCloneCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseCloneParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&databaseCloneParam.Ipaddress1, "ipaddress-1", "", "", "set ipaddress(#1) (aliases: ip1, ipaddress, ip)")
	...
	fs.StringVarP(&databaseCloneParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringSliceVarP(&databaseCloneParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseCloneParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseCloneParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseReplicaCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseReplicaCreateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&databaseReplicaCreateParam.Ipaddress1, "ipaddress-1", "", "", "set ipaddress(#1) (aliases: ip1, ipaddress, ip)")
	...
	fs.StringVarP(&databaseReplicaCreateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringSliceVarP(&databaseReplicaCreateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseReplicaCreateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseReplicaCreateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseMonitorCPUCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseMonitorCPUParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseMonitorCPUParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseMonitorCPUParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseMonitorCPUParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseMonitorMemoryCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseMonitorMemoryParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseMonitorMemoryParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseMonitorMemoryParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseMonitorMemoryParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseMonitorNicCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseMonitorNicParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseMonitorNicParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseMonitorNicParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseMonitorNicParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseMonitorSystemDiskCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseMonitorSystemDiskParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseMonitorSystemDiskParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseMonitorSystemDiskParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseMonitorSystemDiskParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseMonitorBackupDiskCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseMonitorBackupDiskParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseMonitorBackupDiskParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseMonitorBackupDiskParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseMonitorBackupDiskParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseMonitorSystemDiskSizeCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseMonitorSystemDiskSizeParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseMonitorSystemDiskSizeParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseMonitorSystemDiskSizeParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseMonitorSystemDiskSizeParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseMonitorBackupDiskSizeCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseMonitorBackupDiskSizeParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&databaseMonitorBackupDiskSizeParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&databaseMonitorBackupDiskSizeParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&databaseMonitorBackupDiskSizeParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func databaseLogsCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, databaseLogsParam)
			if err != nil {
				return err
			}
	...
	fs := cmd.Flags()
	fs.StringVarP(&databaseLogsParam.LogName, "log-name", "", "all", "set target logfile name (aliases: name)")
