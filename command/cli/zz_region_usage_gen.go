...
func regionCommandOrder(cmd *cobra.Command) []*commandSet {
...
func regionListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func regionReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
