...
func productInternetCommandOrder(cmd *cobra.Command) []*commandSet {
...
func productInternetListFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
...
func productInternetReadFlagOrder(cmd *cobra.Command) []*flagSet {
	var sets []*flagSet
	{
		var fs *pflag.FlagSet
		fs = pflag.NewFlagSet("Input", pflag.ContinueOnError)
