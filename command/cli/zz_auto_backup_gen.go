...
func autoBackupListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, autoBackupListParam)
			if err != nil {
				return err
			}
...
func autoBackupCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, autoBackupCreateParam)
			if err != nil {
				return err
			}
...
func autoBackupReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, autoBackupReadParam)
			if err != nil {
				return err
			}
...
func autoBackupUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, autoBackupUpdateParam)
			if err != nil {
				return err
			}
...
func autoBackupDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, autoBackupDeleteParam)
			if err != nil {
				return err
			}
