			...
			},
			{
				...
				Action: func(c *cli.Context) error {
					...
					if strInput != "" {
						...
						mergo.MergeWithOverwrite(recordInfoParam, p)
					}
			...
			},
			{
				...
				Action: func(c *cli.Context) error {
					...
					if strInput != "" {
						...
						mergo.MergeWithOverwrite(recordAddParam, p)
					}
			...
			},
			{
				...
				Action: func(c *cli.Context) error {
					...
					if strInput != "" {
						...
						mergo.MergeWithOverwrite(recordUpdateParam, p)
					}
			...
			},
			{
				...
				Action: func(c *cli.Context) error {
					...
					if strInput != "" {
						...
						mergo.MergeWithOverwrite(recordDeleteParam, p)
					}
