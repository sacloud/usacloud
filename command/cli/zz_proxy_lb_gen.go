...
func proxyLBListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBListParam)
			if err != nil {
				return err
			}
	...
	fs.StringSliceVarP(&proxyLBListParam.Tags, "tags", "", []string{}, "set filter by tags(AND) (aliases: selector)")
	fs.IntVarP(&proxyLBListParam.From, "from", "", 0, "set offset (aliases: offset)")
	fs.IntVarP(&proxyLBListParam.Max, "max", "", 0, "set limit (aliases: limit)")
	...
	fs.StringVarP(&proxyLBListParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBListParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBListParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBListParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBCreateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBCreateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&proxyLBCreateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBCreateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBCreateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBCreateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBReadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBReadParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBReadParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBReadParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBReadParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBReadParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBUpdateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBUpdateParam.Description, "description", "", "", "set resource description (aliases: desc)")
	...
	fs.StringVarP(&proxyLBUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBPlanChangeCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBPlanChangeParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBPlanChangeParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBPlanChangeParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBPlanChangeParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBPlanChangeParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBBindPortInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBBindPortInfoParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBBindPortInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBBindPortInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBBindPortInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBBindPortInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBBindPortAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBBindPortAddParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBBindPortAddParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBBindPortAddParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBBindPortAddParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBBindPortAddParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBBindPortUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBBindPortUpdateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBBindPortUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBBindPortUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBBindPortUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBBindPortUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBBindPortDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBBindPortDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBBindPortDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBBindPortDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBBindPortDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBBindPortDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBResponseHeaderInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBResponseHeaderInfoParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBResponseHeaderInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBResponseHeaderInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBResponseHeaderInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBResponseHeaderInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBResponseHeaderAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBResponseHeaderAddParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBResponseHeaderAddParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBResponseHeaderAddParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBResponseHeaderAddParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBResponseHeaderAddParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBResponseHeaderUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBResponseHeaderUpdateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBResponseHeaderUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBResponseHeaderUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBResponseHeaderUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBResponseHeaderUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBResponseHeaderDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBResponseHeaderDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBResponseHeaderDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBResponseHeaderDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBResponseHeaderDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBResponseHeaderDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBACMEInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBACMEInfoParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBACMEInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBACMEInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBACMEInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBACMEInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBACMESettingCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBACMESettingParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBACMESettingParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBACMESettingParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBACMESettingParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBACMESettingParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBACMERenewCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBACMERenewParam)
			if err != nil {
				return err
			}
...
func proxyLBServerInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBServerInfoParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBServerInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBServerInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBServerInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBServerInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBServerAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBServerAddParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBServerAddParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBServerAddParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBServerAddParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBServerAddParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBServerUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBServerUpdateParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBServerUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBServerUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBServerUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBServerUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBServerDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBServerDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBServerDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBServerDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBServerDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBServerDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBCertificateInfoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBCertificateInfoParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBCertificateInfoParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBCertificateInfoParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBCertificateInfoParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBCertificateInfoParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBCertificateAddCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBCertificateAddParam)
			if err != nil {
				return err
			}
	...
	fs := cmd.Flags()
	fs.StringVarP(&proxyLBCertificateAddParam.ServerCertificate, "server-certificate", "", "", " (aliases: server-cert)")
	fs.StringVarP(&proxyLBCertificateAddParam.IntermediateCertificate, "intermediate-certificate", "", "", " (aliases: issuer-cert)")
	...
	fs.StringVarP(&proxyLBCertificateAddParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBCertificateAddParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBCertificateAddParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBCertificateAddParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBCertificateUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBCertificateUpdateParam)
			if err != nil {
				return err
			}
	...
	fs := cmd.Flags()
	fs.StringVarP(&proxyLBCertificateUpdateParam.ServerCertificate, "server-certificate", "", "", " (aliases: server-cert)")
	fs.StringVarP(&proxyLBCertificateUpdateParam.IntermediateCertificate, "intermediate-certificate", "", "", " (aliases: issuer-cert)")
	...
	fs.StringVarP(&proxyLBCertificateUpdateParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBCertificateUpdateParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBCertificateUpdateParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBCertificateUpdateParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBCertificateDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBCertificateDeleteParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBCertificateDeleteParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBCertificateDeleteParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBCertificateDeleteParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBCertificateDeleteParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
...
func proxyLBMonitorCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			ctx, err := command.NewCLIContext(globalFlags(), args, proxyLBMonitorParam)
			if err != nil {
				return err
			}
	...
	fs.StringVarP(&proxyLBMonitorParam.OutputType, "output-type", "o", "", "Output type [table/json/csv/tsv] (aliases: out)")
	fs.StringSliceVarP(&proxyLBMonitorParam.Column, "column", "", []string{}, "Output columns(using when '--output-type' is in [csv/tsv] only) (aliases: col)")
	fs.BoolVarP(&proxyLBMonitorParam.Quiet, "quiet", "q", false, "Only display IDs")
	fs.StringVarP(&proxyLBMonitorParam.Format, "format", "", "", "Output format(see text/template package document for detail) (aliases: fmt)")
