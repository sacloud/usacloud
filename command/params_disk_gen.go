...
func (p *EditDiskParam) SetSshKey(v []string) {
	p.SshKey = v
}

func (p *EditDiskParam) GetSshKey() []string {
	return p.SshKey
}
...
func (p *EditDiskParam) SetStartupScript(v []string) {
	p.StartupScript = v
}

func (p *EditDiskParam) GetStartupScript() []string {
	return p.StartupScript
}
...
func (p *CreateDiskParam) Validate() []error {
	errors := []error{}
	{
		validator := define.Resources["Disk"].Commands["create"].Params["icon"].ValidateFunc
	...
	{
		validator := define.Resources["Disk"].Commands["create"].Params["source-disk"].ValidateFunc
		errs := validator("--source-disk", p.SourceDisk)
		if errs != nil {
			errors = append(errors, errs...)
		}
	}
	{
		errs := validateConflicts("--source-disk", p.SourceDisk, map[string]interface{}{

			"--source-archive": p.SourceArchive,
		})
		if errs != nil {
			errors = append(errors, errs...)
		}
	...
	{
		validator := define.Resources["Disk"].Commands["create"].Params["source-archive"].ValidateFunc
		errs := validator("--source-archive", p.SourceArchive)
		if errs != nil {
			errors = append(errors, errs...)
		}
	}
	{
		errs := validateConflicts("--source-archive", p.SourceArchive, map[string]interface{}{

			"--source-disk": p.SourceDisk,
		})
		if errs != nil {
			errors = append(errors, errs...)
		}
...
func (p *CreateDiskParam) SetIcon(v int64) {
	p.Icon = v
}

func (p *CreateDiskParam) GetIcon() int64 {
	return p.Icon
}
...
func (p *CreateDiskParam) SetSourceDisk(v int64) {
	p.SourceDisk = v
}

func (p *CreateDiskParam) GetSourceDisk() int64 {
	return p.SourceDisk
}
...
func (p *CreateDiskParam) SetSourceArchive(v int64) {
	p.SourceArchive = v
}

func (p *CreateDiskParam) GetSourceArchive() int64 {
...
func (p *UpdateDiskParam) Validate() []error {
	...
	{
		validator := define.Resources["Disk"].Commands["update"].Params["icon"].ValidateFunc
		errs := validator("--icon", p.Icon)
		if errs != nil {
			errors = append(errors, errs...)
		}
...
func (p *UpdateDiskParam) SetIcon(v int64) {
	p.Icon = v
}

func (p *UpdateDiskParam) GetIcon() int64 {
	return p.Icon
}
...
func (p *ReinstallFromArchiveDiskParam) Validate() []error {
	...
	{
		validator := define.Resources["Disk"].Commands["reinstall-from-archive"].Params["source-archive"].ValidateFunc
		errs := validator("--source-archive", p.SourceArchive)
		if errs != nil {
			errors = append(errors, errs...)
		}
...
func (p *ReinstallFromArchiveDiskParam) SetSourceArchive(v int64) {
	p.SourceArchive = v
}

func (p *ReinstallFromArchiveDiskParam) GetSourceArchive() int64 {
	return p.SourceArchive
}
...
func (p *ReinstallFromDiskDiskParam) Validate() []error {
	...
	{
		validator := define.Resources["Disk"].Commands["reinstall-from-disk"].Params["source-disk"].ValidateFunc
		errs := validator("--source-disk", p.SourceDisk)
		if errs != nil {
			errors = append(errors, errs...)
		}
...
func (p *ReinstallFromDiskDiskParam) SetSourceDisk(v int64) {
	p.SourceDisk = v
}

func (p *ReinstallFromDiskDiskParam) GetSourceDisk() int64 {
	return p.SourceDisk
}
...
func (p *ServerConnectDiskParam) Validate() []error {
	...
	{
		validator := validateRequired
		errs := validator("--server", p.Server)
		if errs != nil {
			errors = append(errors, errs...)
		}
	}
	{
		validator := define.Resources["Disk"].Commands["server-connect"].Params["server"].ValidateFunc
		errs := validator("--server", p.Server)
		if errs != nil {
			errors = append(errors, errs...)
		}
...
func (p *ServerConnectDiskParam) SetServer(v int64) {
	p.Server = v
}

func (p *ServerConnectDiskParam) GetServer() int64 {
	return p.Server
}
