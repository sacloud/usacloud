...
func InternetIpv6Info(ctx command.Context, params *params.Ipv6InfoInternetParam) error {
	...
	if e != nil {
		return fmt.Errorf("InternetIpv6Info is failed: %s", e)
	}

	// set params

	// TODO Remove and implements here!!
	return fmt.Errorf("Not Implements InternetIpv6Info : %#v", p)

	// call manipurate functions
	// res, err := api.XXXX(params.Id, p)
	// if err != nil {
	// 	return fmt.Errorf("InternetIpv6Info is failed: %s", err)
	// }
