...
func init() {
						...
						for _, flag := range c.App.Command(commandName).Flags {
							...
							if exists {
								if _, ok := flag.(*cli.BoolFlag); ok {
									...
									BridgeCreateCompleteFlags(ctx, createParam, name, cur)
									return
								}
							}
						}
						...
						for _, flag := range c.App.Command(commandName).Flags {
							...
							if exists {
								if _, ok := flag.(*cli.BoolFlag); ok {
									...
									// prev is flag , call completion func of each flags
									BridgeDeleteCompleteFlags(ctx, deleteParam, name, cur)
									return
								}
							}
						}
						...
						for _, flag := range c.App.Command(commandName).Flags {
							...
							if exists {
								if _, ok := flag.(*cli.BoolFlag); ok {
									...
									// prev is flag , call completion func of each flags
									BridgeListCompleteFlags(ctx, listParam, name, cur)
									return
								}
							}
						}
						...
						for _, flag := range c.App.Command(commandName).Flags {
							...
							if exists {
								if _, ok := flag.(*cli.BoolFlag); ok {
									...
									// prev is flag , call completion func of each flags
									BridgeReadCompleteFlags(ctx, readParam, name, cur)
									return
								}
							}
						}
						...
						for _, flag := range c.App.Command(commandName).Flags {
							...
							if exists {
								if _, ok := flag.(*cli.BoolFlag); ok {
									...
									// prev is flag , call completion func of each flags
									BridgeUpdateCompleteFlags(ctx, updateParam, name, cur)
									return
								}
							}
						}
	...
	appendFlagCategoryMap("bridge", "delete", "force", &schema.Category{
		Key:         "default",
		DisplayName: "Common options",
		Order:       2147483646,
	})
