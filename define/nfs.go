...
func nfsCreateParam() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"size": {
			...
			Required:     true,
			DefaultValue: 100,
			Description:  "set plan[20/100/500/1024/2048/4096/8192/12288]",
			ValidateFunc: validateInIntValues(sacloud.AllowNFSAllPlanSizes()...),
			CompleteFunc: completeInIntValues(sacloud.AllowNFSAllPlanSizes()...),
			Category:     "nfs",
			Order:        45,
		},
		"ipaddress": {
